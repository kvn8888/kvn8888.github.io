...
export const MANAGED_SECRET_GROUPS: ManagedSecretGroup[] = [
  ...
  },
  {
    ...
    icon: 'sync_alt',
    keys: [
      { key: 'JOBS_EXTENSION_API_KEY', description: 'Optional extension credential for applications and collection (32+ characters)' },
      { key: 'JOBS_READ_API_KEY', description: 'Optional read-only credential for applications and collection (32+ characters)' },
