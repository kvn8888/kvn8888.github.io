...
out=root/'dist/ats-handoff-1.0.2.zip'
entries={}
...
manifest={'version':'1.0.2','schema_version':'1.0','artifact':out.name,'sha256':hashlib.sha256(out.read_bytes()).hexdigest(),'size':out.stat().st_size,'files':len(entries),'telemetry':False,'tracker_sync':False,'cookie_transfer':False}
